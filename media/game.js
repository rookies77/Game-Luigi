...
sound.stack = new Audio();
sound.stack.src = 'asset/stack.wav';
...
function main() {
    ...
    // bg.sprite.addEventListener("load", function () {
    //     // first draw of bg sprite
    //     // ctx.drawImage(bg.sprite, bg.x, bg.y, bg.w, bg.h);

    //     // console.log("Bg sprite loaded");
    // });
    // call setIntervall and start game loop
